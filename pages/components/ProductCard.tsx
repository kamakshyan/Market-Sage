...
export default function ProductCard(props: any) {
  const resolveAfterSec = new Promise(resolve => setTimeout(resolve, 5000));
  ...
  return (
    <div className="hover:cursor-pointer group flex flex-col min-h-[250px] md:min-w-[400px] mb-5">
      ...
      <button
        onClick={addToCart}
        className="mt-4 text-sm hover:bg-black hover:text-white mb-5 w-32 text-center rounded-full px-5 py-3 border border-black"
      >
        Add to Cart
      </button>
    </div>
